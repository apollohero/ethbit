    ...
    return Scaffold(
       appBar: AppBar(
         brightness: Brightness.dark,
           centerTitle: true,
           title: Text("行情",style: TextStyle(color: Theme.of(context).textSelectionColor,fontFamily: "Gotik",fontWeight: FontWeight.w600,fontSize: 18.5),),
           actions: <Widget>[
             Padding(
           ...
           bottom: TabBar(
             ...
             tabs: <Widget>[
               new Tab(
       child: Text("BTC",style: TextStyle(fontFamily: "Popins"),),
               ),
               new Tab(
        child: Text("USDT",style: TextStyle(fontFamily: "Popins"),),
               ),
               new Tab(
       child: Text("XRP",style: TextStyle(fontFamily: "Popins"),),
               ),
               new Tab(
        child: Text("ETH",style: TextStyle(fontFamily: "Popins"),),
               ),
             ],
           ),
         ),
