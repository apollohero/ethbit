             ...
             Row(
               ...
               children: <Widget>[
                 Padding(
                   ...
                   child: Container(
                       width: 100.0,
                       child: Text("交易对",style: TextStyle(color: Theme.of(context).hintColor,fontFamily: "Popins"),)),
                 ),
                 Container(
                     width: 100.0,
                     child: Text("最新价格",style: TextStyle(color: Theme.of(context).hintColor,fontFamily: "Popins"),)),
                 Container(
                     width: 80.0,
                     child: Text("24h涨幅",style: TextStyle(color: Theme.of(context).hintColor,fontFamily: "Popins"),)),
               ],
             ),
     SizedBox(height: 0.0,),
     ///
  ...
  return Padding(
    ...
    child: Shimmer.fromColors(
      baseColor: Color(0xFF3B4659),
          ...
          Padding(
            padding: const EdgeInsets.only(left:10.0,right: 20.0,top: 0.0),
            child: Container(
...
Widget card(BuildContext ctx,btcMarket item){
  return Padding(
    ...
    child: Column(
        ...
        InkWell(
          onTap: (){
            Navigator.of(ctx).push(PageRouteBuilder(pageBuilder: (_,__,___)=> new btcDetail(item:item)));
          },
                  child: Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            crossAxisAlignment: CrossAxisAlignment.center,
