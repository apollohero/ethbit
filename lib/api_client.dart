...
class ApiClient {
  ...
  static const String baseUrl = '47.91.228.105:8060';
//  static const String baseUrl = 'http://192.168.0.107:3001/';
  ...
  Future<dynamic> login() async {
    ...
    Response<Map> response = await dio.post('users/login',data: {
      user_name,
      passwd
    });
...
//      print(e);
  ...
  Future<dynamic> getUserInfo(String token) async {
    try {
      return await dio.get('/users',options:Options(
          headers: {
            HttpHeaders.authorizationHeader:token
          }
      ));
  ...
  Future<dynamic> getMyMembers(String token) async {
    try {
      return await dio.get('/promotion/mymember',options:Options(
          headers: {
            HttpHeaders.authorizationHeader:token
          }
      ));
  ...
  Future<dynamic> sendEmail(String email) async {
    ...
    Response response;
    try {
      return await dio.post('/sms/send/email',data: {
        "email":email
      });
  ...
  //登陆login
  Future<dynamic> resetPassword(String phoneNum,String code,String password,String type) async {
    Response response;
    try {
      return await dio.put('users/reset/password',data: {
        "phone":phoneNum,
        "code":code,
        "password":password,
        "type":type
  ...
  Future<dynamic> changePhone(String oldPhone,String newPhone,String code,String Token) async {
    Response response;
    try {
      return await dio.put('users/phone',data: {
        "oldPhone":oldPhone,
        "newPhone":newPhone,
        "code":code,
      },
  ...
  Future<dynamic> changeName(String name,String Token) async {
    Response response;
    try {
      return await dio.put('users/info',data: {
        "user_name":name,
      },
          options:Options(
              headers: {
  ...
  Future<dynamic> register(String phone_num,String user_name,String passwd,String parent_code,String code) async {
    Response response;
    try {
      return await dio.post('/darasakor-api/api/users/register',data: {
        'phone_num':phone_num,
        'user_name':user_name,
        'passwd':passwd,
...
//        'location_area':location_area,
  ...
  Future<dynamic> mail_register(String mail_address,String user_name,String passwd,String parent_code,String code) async {
    Response response;
    try {
      return await dio.post('users/register/email',data: {
